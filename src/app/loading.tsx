...
export default function Loading() {
  return (
    <>
      <Navbar />
      <main className="min-h-[calc(100dvh-4.5rem)] bg-canvas px-4 py-16 sm:px-6 sm:py-24" aria-busy="true">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 space-y-3" aria-hidden="true">
            ...
            <div className="skeleton h-12 max-w-xl rounded-xl border border-border" />
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="skeleton h-40 rounded-2xl border border-border" />
              <div className="skeleton h-40 rounded-2xl border border-border" />
            </div>
          </div>
        </div>
