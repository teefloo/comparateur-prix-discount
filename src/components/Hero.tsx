    ...
    <section className="relative pt-28 pb-20 overflow-hidden bg-gradient-to-b from-accent-subtle/50 to-white dark:from-slate-800 dark:to-slate-900">
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-base sm:text-lg text-muted mb-10 max-w-2xl mx-auto leading-relaxed dark:text-slate-400">
          Le seul outil qui compare instantanément Action, Stokomani, B&M, Centrakor, Aldi, GiFi, La Foir&apos;Fouille et Lidl pour vous garantir le prix le plus bas sur vos produits du quotidien.
        </p>
        ...
        >
          {[
            ...
            { icon: ShoppingBag, label: '8 enseignes leader', desc: "Action, B&M, Stokomani, Centrakor, Aldi, GiFi, La Foir'Fouille, Lidl" },
          ].map((feature, idx) => (
