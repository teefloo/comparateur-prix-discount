...
import { Home, Info, Menu, Moon, ShoppingBag, Sun, X } from 'lucide-react'
    ...
    <>
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 py-3 sm:h-[4.5rem] sm:px-6">
          ...
          <div className="hidden items-center gap-2 md:flex">
            ...
            <Link href="/a-propos" className="nav-pill">
              À propos
            </Link>
            <button
              onClick={toggleTheme}
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-line bg-paper/95 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90 md:hidden safe-area-bottom">
        <div className="mx-auto grid max-w-7xl grid-cols-3 px-4 py-2">
          <Link href="/" className="flex flex-col items-center gap-1 rounded-2xl px-3 py-2 text-muted transition-colors hover:text-foreground dark:text-slate-400 dark:hover:text-slate-100">
            <Home size={16} />
            <span className="text-[11px] font-semibold">Accueil</span>
          </Link>
          <Link href="#categories" className="flex flex-col items-center gap-1 rounded-2xl px-3 py-2 text-muted transition-colors hover:text-foreground dark:text-slate-400 dark:hover:text-slate-100">
            <ShoppingBag size={16} />
            <span className="text-[11px] font-semibold">Catégories</span>
          </Link>
          <Link href="/a-propos" className="flex flex-col items-center gap-1 rounded-2xl px-3 py-2 text-muted transition-colors hover:text-foreground dark:text-slate-400 dark:hover:text-slate-100">
            <Info size={16} />
